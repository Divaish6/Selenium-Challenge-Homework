...
public class Utility extends ManageBrowser {
    ...
    /**
     * This method will find elements from the webpage
     *
     */
...
//    }
    ...
    public String getAttributeValue(WebElement element,String name){
        ...
        return driver.findElement((By) element).getAttribute(name);
    }
...
//***************************** Is Display Methods **********************************************//
    ...
    public void assertVerifyText(WebElement element,String expectedText,String text)
    {
        String actualText=getTextFromElement(element);
        Assert.assertEquals(actualText,expectedText,text);
    }
    public void verifyListProduct(List<WebElement> element) {
        List<WebElement> element1 =element;
        for (WebElement result : element1) {
            System.out.println(result.getText());
        }
    }

    public void softAssertVerifyText(WebElement element,String expectedText)
    {
        SoftAssert softAssert = new SoftAssert();
        String actualText=getTextFromElement(element);
        softAssert.assertEquals(actualText,expectedText,"text Not match");
